        ...
        body.entry.forEach(function (entry) {
                ...
                "attachment" : {
                    ...
                    "payload": {
                        ...
                        "buttons": [
                      	 {
           				 "type":"phone_number",
           				 "title":"အရေးပေါ်ခေါ်ဆိုမှု/ Emergency call",
           				 "payload":"+95119"
         				 }, 

                         {
                            "type": "postback",
                            "title": "ကုသမှု/ Treatments",
                            "payload": "ကုသမှု"
                        },
            ...
            requestify.post(`https://graph.facebook.com/v5.0/me/messages?access_token=${pageaccesstoken}`, buttonMesage
                ...
                "attachment" : {
                    ...
                    "payload": {
                        "template_type": "button",
                        "text": "ဘာသာစကားရွေးပါ/Choose your language",
                        "buttons": [
                         {
                         "type":"postback",
                         "title":"English",
           ...
           else if (userInput == 'bma' || userButton == 'bma') {
                ...
                "attachment" : {
                    ...
                    "payload": {
                        ...
                        "buttons": [
                      	 {
           				 "type":"postback",
           				 "title":"First-aid kit ဝယ်ရန်/ Buy first-aid kit",
           				 "payload":"firstaid"
         				 }, 
...
\n\n11.သာမိုမီတာ\n\n\nဈေးနှုန်: = 15000 ks`,
            ...
            requestify.post(`https://graph.facebook.com/v5.0/me/messages?access_token=${pageaccesstoken}`, buttonMesage
            	...
            	let message = {
                   ...
                   "message": { 
                   	 "text":`ဖုန်းနံပါတ်ရေးပါ။/ Phone Number`
					}
            	}
            	...
            	let message = {
                   ...
                   "message": { 
                   	 "text":`နာမည်ရေးပါ(Name) ${userAnswers.name}, ဖုန်းနံပါတ်(Phone) ${userAnswers.phone}, လိပ်စာ(Address) ${userAnswers.address}.`,
                   	 "quick_replies":[
				      {
				        "content_type":"text",
				        "title":"Correct",
                 ...
                 else if(userInput == "term" || userButton == "term")
          {
                let buttonMesage = {
                    ...
                    "message":{
                        "text":`1.ပြထားသောဆေးကုသနည်းများမှာ ခဏတာ သက်သာစေရန်သာဖြစ်သည်။ ပြထားငည့်အတိုင်းကုသပြီးပါက ဆရာဝန်နှင့်ထပ်ပြရန်လိုအပ်ပါသည်။(The showns treatments are only for temporarily cure. Patient should still seek medical attention even after the treatment)\n\n2.First-aid kit  တွင်ပါသောဆေးများမှာ ဘေးဥပဒ် မဖြစ်စေရန် အာမခံသည်။(It is gurantee that medicines which are inculded in first-aid kit have no side effect)`
                    },
            ...
            requestify.post(`https://graph.facebook.com/v5.0/me/messages?access_token=${pageaccesstoken}`, buttonMesage
           ...
           else if(userInput == 'about' || userButton == 'about')
             {
                let buttonMesage = {
                    ...
                    "message":{
                        "text":`Online Firt-aid သည်လူအများ၏ကျမ်းမာရေးအတွက်ဦးတည်၍ထုပ်ထားခြင်းဖြသသည်။ အရေးပေါ်ကိစ္စများနှင့် နေ့စဉ်ကြုံတွေ့နိုင်သောဒဏ်ရာများအတွက် အလွယ်တကူကုသနိုင်သောနည်းလမ်းများကိုဖော်ပြထားပါသည်။(Online first aid is created in order to save lives in emergency cases and to make people healthy) `
                         },
